...
class SettingsView extends GetView<SettingsController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Help & Support",
          style: TextStyle(color: Color(0XFFB3B3B3), fontSize: 25, fontWeight: FontWeight.normal), // Set title color to white
        ),
        actions: [
          IconButton(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        _buildFullWidthButton(Icons.chat, "Chat", controller.onChatPressed),
                        SizedBox(height: 8), // Space between buttons
                        _buildFullWidthButton(Icons.call, "Voice Call", controller.onVoiceCallPressed),
                        SizedBox(height: 8), // Space between buttons
                        _buildFullWidthButton(Icons.video_call, "Video Call", controller.onVideoCallPressed),
                      ],
                    ),
                  ],
                ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        _buildFullWidthButton(Icons.chat, "Chat", controller.onChatbotPressed),
                      ],
                    ),
                  ],
                ),
  ...
  Widget _buildFullWidthButton(IconData icon, String label, VoidCallback onPressed) {
    return ElevatedButton(
      ...
      child: Row(
        children: [
          ...
          Text(
            label,
            style: TextStyle(color: Color(0XFFCCE16B)), // Change text color to CCE16B
          ),
        ],
      ),
    );
