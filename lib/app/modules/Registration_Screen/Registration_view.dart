      ...
      Row(
        children: [
          Container(
            ...
            child: Text("Don't have an account yet?", style: TextStyle(color: Colors.white54,fontWeight: FontWeight.w500),),
          ),SizedBox(width: 3,),
          Container(
            margin: EdgeInsets.only(right: 0),
            child: Text("Sign up", style: TextStyle(color: Color.fromARGB(255, 205,226,109),fontWeight: FontWeight.w500),),),
        ],
      ),SizedBox(height: 10,)
    ],
    ),
