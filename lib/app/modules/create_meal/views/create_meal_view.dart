    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            SizedBox(width: 20), // Adjust width to create space from the back icon
            Expanded(
              child: Text(
                'Creating A Meal',
            ...
            SizedBox(width: 50), // Adjust width to create space on the right side
          ],
        ),
      ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Stack(
                alignment: Alignment.center, // Align camera icon at the center
                children: [
                  // Background Image
                  Container(
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: Colors.white, width: 3), // White outline (thicker)
                      ),
                      child: Center(
                        child: Icon(
                          Icons.camera_alt,
            ...
            Row(
              ...
              children: [
                Text("Calculate Automatically", style: TextStyle(color: Color(0XFFDBDBDB))),
                Obx(() {
                  return Switch(
                    ...
                    activeColor: Colors.greenAccent, // Color when the switch is on
                    inactiveTrackColor: Color(0XFF7E7E7E), // Track color when the switch is off
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: controller.printMealData,
                      child: Text("Create Meal", style: TextStyle(fontSize: 17),),
                      style: ElevatedButton.styleFrom(
                        foregroundColor: Color(0XFF242522),
                        backgroundColor: Color(0XFFCDE26D),
...
class IngredientInput extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(bottom: 10), // Add margin at the bottom for spacing
      child: Row(
        children: [
          Expanded(
            child: TextField(
