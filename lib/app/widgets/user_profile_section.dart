...
class UserProfileSection extends StatelessWidget {
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    _buildInfoRow('User Name: ', userData["username"]?.toString() ?? "Ayush Shukla"),
                    const SizedBox(height: 4),
                    _buildInfoRow('Plan Name: ', userData["planName"]?.toString() ?? "Keto Plan"),
                    const SizedBox(height: 4),
                    _buildInfoRow('Plan Duration: ', userData["planDuration"]?.toString() ?? "Oct 1 - Nov 1"),
                    const SizedBox(height: 4),
                    _buildInfoRow('Email: ', userData["email"]?.toString() ?? "ayush@gmail.com"),
                  ],
                ),
              ),
              Column(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildNutrientColumn('35', '/75', 'Proteins', const Color(0XFFFF5122)),
              _buildVerticalDivider(),
              _buildNutrientColumn('120', '/200', 'Carbs', Colors.yellow),
              _buildVerticalDivider(),
              _buildNutrientColumn('35', '/75', 'Fats', const Color(0XFF8B3BFF)),
            ],
          ),
        ],
      ),
  ...
  Widget _buildNutrientColumn(String mainValue, String subValue, String title, Color color) {
    return Column(
